 ...
 *
 * There is also a Color class in the java.awt package, but we wanted simplicity
 * and full access to the code.
 *
 * @author ags
 */
public class Color extends Tuple {
	 ...
	 * java.awt.BufferedImage.TYPE_INT_RGB. (i.e., - the low 8 bits, 0-7 are for
