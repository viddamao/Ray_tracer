...
public class SphereMath {
	...
	public static double getB(double dx, double dy, double dz, Point start, Point center){
		return 2*dx*(start.x-center.x)+2*dy*(start.y-center.y)+2*dz*(start.z-center.z);
	}

	public static double getC(double dx, double dy, double dz, Point start, Point center, double radius){
