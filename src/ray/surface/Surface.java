...
public abstract class Surface {
    ...
    /**
     * Calculates t values for which ray intersects this surface, returns an
     * array with 0, 1, or 2 elements.
     *
     * @param ray
     *            the ray being projected
     * @return an array of t values for which an intersection of this surface
     *         with ray occurs
     */
     ...
     *
     * @param point
     *            the point for which we're calculating the normal vector
